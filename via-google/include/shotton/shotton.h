...
void set_1st_order(cv::Mat img, ProbImage unary_mat, double unaryWeight, const size_t n_label, GraphicalModel& gm);
...
void set_2nd_order(cv::Mat img, const size_t n_label, EnergyParam energy_param,double pairWiseWeight, GraphicalModel& gm);
