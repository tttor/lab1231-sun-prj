...
SAMPLE      read_struct_examples(char *file, STRUCT_LEARN_PARM *sparm)
{
  ...
  n=countFileLine(file); /* replace by appropriate number of examples */
  ...
  if(reader.is_open())
  {
    while(getline(reader,imagename))
    {
      string unary_path = dataset::unary_directory + "/" + imagename + ".unary";
      string png_path = dataset::png_directory + "/" + imagename + ".png";
      string image_path = dataset::jpg_directory + "/" + imagename + ".jpg";
      string dumping_path = dataset:: dumping_directory + "/" + imagename + ".png";
