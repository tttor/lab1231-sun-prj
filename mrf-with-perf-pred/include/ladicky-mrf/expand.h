...
class AExpand
{
	...
	private :
		...
		termType compute_energy()
		{
			...
			const termType unaryCost = tempE;
			// std::cout << "compute_energy()::unaryCost= " << unaryCost << std::endl;
			...
			const termType pairCost = tempE - unaryCost;
			// std::cout << "compute_energy()::pairCost= " << pairCost << std::endl;
