...
int main(int argc, char *argv[]) {
    ...
    cv::Mat mat = cv::imread("dog.png", CV_LOAD_IMAGE_COLOR);
    ...
    // spatial term.
     vl_size region = 30;
    //vl_size region = atoi(argv[2]);

     float regularization = 10000.; //awal = 1000.
    //float regularization = 1.0*atoi(argv[3]);
    
    //vl_size minRegion = atoi(argv[4]);
