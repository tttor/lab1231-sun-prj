...
class KnowledgeConstructor: 
    ...
    def __init__(self, fileOutputName):
        ...
        pName="csv/properties" + fileOutputName +".csv"
        rName="csv/relative" + fileOutputName +".csv"
    ...
    def set_xml_data_dir(self, xml_dir):
        self.xmldat=xml_dir
        self.rxmlpath="/home/ian-djakman/Documents/data/input/voc_dataset_2012/voc_gt_xml"
    ...
    def sXML(self):
        ...
        xmlFilename='/home/ian-djakman/Documents/data/output/knowledge-compatibility-benchmarker/knowledge/spatial_knowledge.xml'
    ...
    def cXML(self):
        ...
        xml_filepath = '/home/ian-djakman/Documents/data/output/knowledge-compatibility-benchmarker/knowledge/cooccurence_knowledge.xml'
        ...
        for key, val in p_knowledge_dictionary.items():
            ...
            for subkey, subval in val.items():
                ...
                if total != 0.0:
                    ...
                    subsubsub.set("norm_freq", "0.0")
        xml_filepath = "/home/ian-djakman/Documents/data/output/knowledge-compatibility-benchmarker/knowledge/scene_properties_knowledge.xml"
        writer = etree.ElementTree(root)
        writer.write(xml_filepath, pretty_print=True)
    ...
    def rXML(self):
        ...
        xml_filepath = '/home/ian-djakman/Documents/data/output/knowledge-compatibility-benchmarker/knowledge/relativeposition_knowledge.xml'
        writer = etree.ElementTree(root)
        writer.write(xml_filepath, pretty_print=True)
